...
# ./bench-multi.py $@ --capture-output q0-new noir ${NOIR_HOME}/noir nexmark -- 100000000 0
# ./bench-multi.py $@ --capture-output q1-new noir ${NOIR_HOME}/noir nexmark -- 100000000 1
# ./bench-multi.py $@ --capture-output q2-new noir ${NOIR_HOME}/noir nexmark -- 100000000 2
# ./bench-multi.py $@ --capture-output q3-new noir ${NOIR_HOME}/noir nexmark -- 100000000 3
# ./bench-multi.py $@ --capture-output q4-new noir ${NOIR_HOME}/noir nexmark -- 100000000 4
# ./bench-multi.py $@ --capture-output q5-new noir ${NOIR_HOME}/noir nexmark -- 100000000 5
# ./bench-multi.py $@ --capture-output q6-new noir ${NOIR_HOME}/noir nexmark -- 100000000 6
# ./bench-multi.py $@ --capture-output q7-new noir ${NOIR_HOME}/noir nexmark -- 100000000 7
# ./bench-multi.py $@ --capture-output q8-new noir ${NOIR_HOME}/noir nexmark -- 100000000 8
...
# ./bench-multi.py $@ wordcount-opt noir ${NOIR_HOME}/noir wordcount_opt -- ${NOIR_HOME}/data/wordcount/gutenberg_4g.txt
...
# ./bench-multi.py $@ kmeans-30c-30it-200M noir ${NOIR_HOME}/noir kmeans -- 30 30 ${NOIR_HOME}/data/kmeans/200M.csv
# ./bench-multi.py $@ kmeans-300c-30it-200M noir ${NOIR_HOME}/noir kmeans -- 300 30 ${NOIR_HOME}/data/kmeans/200M.csv
# ./bench-multi.py $@ kmeans-30c-30it-2000M noir ${NOIR_HOME}/noir kmeans -- 30 30 ${NOIR_HOME}/data/kmeans/2000M.csv
